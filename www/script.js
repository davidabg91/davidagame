...
// Capacitor/Cordova event listeners за мобилни устройства
document.addEventListener('deviceready', function() {
    console.log('Device is ready');
    // Инициализиране на приложението след като устройството е готово
    initializeApp();
}, false);

// Fallback за уеб браузър
if (typeof cordova === 'undefined') {
    console.log('Running in web browser');
    // Инициализиране на приложението в браузър
    initializeApp();
}

function initializeApp() {
    // Тук можеш да добавиш специфична логика за мобилни устройства
    console.log('App initialized');
}

// Предотвратяване на zoom на мобилни устройства
